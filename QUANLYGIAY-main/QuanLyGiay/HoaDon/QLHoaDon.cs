...
namespace GUI_QuanLyGiay.HoaDon
{
    ...
    {
        private BUS_DangNhap busDangNhap = new BUS_DangNhap();
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            String maNhanVien = busDangNhap.getUserLogined().maNhanVien;
            DTO_HoaDon dtoHoaDon = new DTO_HoaDon(maHoaDon, maNhanVien, "", 0);
